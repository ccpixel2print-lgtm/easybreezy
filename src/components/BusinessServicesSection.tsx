...
interface BusinessServicesSectionProps {
  /** Where the "Contact Us" buttons should link (smooth-scroll anchor). */
  contactHref?: string;
}

/**
 * B2B "For Businesses & Societies" section.
 * Maps over the shared `businessServices` data array. `contactHref` lets it
 * scroll to the on-page contact section (home) or route back to it (/#contact).
 */
          ...
          {businessServices.map((s, i) => (
            ...
            >
              ...
              <div className="flex flex-1 flex-col p-5">
                <p className="flex-1 text-sm text-ink/65">{s.description}</p>
                <a
                  href={contactHref}
